...
// o programa pegar posiçoes de uma matriz e multpicar elas, em seguida ele soma e subtrair essas multiplicações de matrizes
// o resultado dessa matriz é igual a: -5
